...
<body class="body">
  ...
  audio.play();
    ...
    <p class="text">
    <?php echo $lang['textSupport'] ?>
    </p>
</div>
<pre>
        <a class="nav-steag1" href="support.php?lang=en"><img src="poze/en.png" width=50px ></a>            <a class="nav-steag2" href="support.php?lang=ro"><img src="poze/ro.png"width= 50px><a>    
    </pre>  
</body>
</html>